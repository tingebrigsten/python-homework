...
* The slides for this lesson can be viewed on Google Drive here: [Lesson Slides](https://docs.google.com/a/2tor.com/presentation/d/1O_1Ncu_fR_BVyaYWeOozBP7ZarO7MDswxJ3lwM9dTck/edit?usp=sharing).
...
After presenting the Lambda function's building blocks, copy and paste the code from VSCode to the code editor on the AWS Lambda console, click on the _Deploy_ button to continue.
